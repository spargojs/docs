...
(() => {
  ...
  function generateProps(object, element) {
    ...
    return __spreadValues(__spreadValues({}, expandedObject), object);
  }
    ...
    generateVNodeForElement(child, ifData, object, nodeData) {
      ...
      switch (childElement.nodeName) {
        case "INPUT": {
          ...
          nodeData.props = generateProps(__spreadValues(__spreadValues({}, props), nodeData.props), childElement);
    ...
    */
    ...
    nodeWithTextContent(childElement, nodeData) {
      ...
      if (((_a = childElement.textContent) == null ? void 0 : _a.trim()) !== "" && childElement.children.length === 0) {
        nodeData.props = generateProps(__spreadValues({}, nodeData.props), childElement);
    ...
    textNode(childElement, object, nodeData) {
      ...
      if (textAttribute) {
        ...
        nodeData.props = generateProps(__spreadValues({ text: textAttribute }, nodeData.props), childElement);
